...
const projects = [
  {
    num: "01", name: "E-Commerce Dashboard", year: "2024", role: "Full-Stack Developer",
    icon: "🖥️", tags: ["React", "Node.js", "MongoDB"],
    desc: "Full-stack admin panel with real-time analytics, order management, and inventory tracking for small online stores.",
    live: "https://example.com", github: "https://github.com",
    longDesc: "A comprehensive e-commerce administration platform built for small to medium online businesses. The dashboard provides real-time sales analytics, inventory management, order processing, and customer insights — all in a clean, fast interface.",
    highlights: [
      "Real-time order notifications via WebSockets",
      "Interactive sales charts with drill-down by product and date range",
      "CSV export for inventory and order reports",
      "Role-based access control for staff accounts",
      "Mobile-responsive layout for on-the-go management",
    ],
    challenge: "Keeping the UI fast and reactive with high-frequency data updates without overwhelming the browser — solved by debouncing socket events and virtualizing long table lists.",
  },
  {
    num: "02", name: "Task Manager App", year: "2024", role: "Frontend Developer",
    icon: "📋", tags: ["Vue.js", "Tailwind", "Firebase"],
    desc: "Minimal productivity app with drag-and-drop boards, deadline reminders, and team collaboration features.",
    live: "https://example.com", github: "https://github.com",
    longDesc: "A Kanban-style task management tool designed for small teams. Users can create boards, drag tasks between columns, assign due dates, and receive browser notifications for upcoming deadlines. Real-time collaboration is powered by Firebase Firestore.",
    highlights: [
      "Drag-and-drop task cards with smooth CSS transitions",
      "Real-time sync across multiple browser tabs and users",
      "Due date reminders via browser Notification API",
      "Markdown support in task descriptions",
      "Persistent dark mode preference stored locally",
    ],
    challenge: "Handling optimistic UI updates for drag-and-drop while staying in sync with Firestore — implemented a local state layer that reconciles with the server on conflict.",
  },
  {
    num: "03", name: "Photography Portfolio", year: "2023", role: "Full-Stack Developer",
    icon: "📷", tags: ["Next.js", "Prisma", "PostgreSQL"],
    desc: "Fast, SEO-optimized portfolio with gallery management, lazy loading, and a custom CMS built from scratch.",
    live: "https://example.com", github: "https://github.com",
    longDesc: "A performant photography showcase built for a professional photographer. Features a custom CMS for managing albums and photos, automatic WebP conversion on upload, lazy-loaded galleries, and perfect Lighthouse scores across all metrics.",
    highlights: [
      "Custom CMS with drag-to-reorder album management",
      "Automatic image compression and WebP conversion on upload",
      "Infinite scroll gallery with blur placeholder loading",
      "Server-side rendering for fast first paint and great SEO",
      "Contact form with email notifications via Resend API",
    ],
    challenge: "Achieving sub-2s LCP on gallery pages with hundreds of high-res images — solved with Next.js Image optimization, blur placeholders, and edge caching via Vercel.",
  },
  {
    num: "04", name: "Weather Dashboard", year: "2023", role: "Frontend Developer",
    icon: "🌤️", tags: ["JavaScript", "HTML/CSS", "REST API"],
    desc: "Clean weather app pulling live data from multiple APIs, with location search, 7-day forecasts and animated icons.",
    live: "https://example.com", github: "https://github.com",
    longDesc: "A lightweight, zero-dependency weather application that aggregates data from the Open-Meteo and OpenStreetMap APIs. Users can search any city worldwide, view hourly and 7-day forecasts, and see animated weather icons that update based on real conditions.",
    highlights: [
      "City search with autocomplete using Nominatim geocoding",
      "Hourly and 7-day forecast including wind, humidity, and UV index",
      "CSS-animated weather icons for sun, clouds, rain, and snow",
      "Geolocation support for instant local weather on load",
      "Fully offline-capable with Service Worker caching",
    ],
    challenge: "Normalizing and displaying weather data consistently across different timezones and DST rules — handled with the Intl.DateTimeFormat API and careful UTC offset math.",
  },
];
...
function Nav({ active }) {
  ...
  return (
    <nav style={{
      ...
      <a href="#hero" style={{ fontFamily: "var(--serif)", fontSize: "1.25rem", fontWeight: 400, color: "var(--ink)", textDecoration: "none", letterSpacing: "-0.01em" }}>YN.</a>
...
/* ── ABOUT ── */
function About() {
  const stats = [{ num: "10+", label: "Projects" }, { num: "3+", label: "Years exp." }, { num: "5+", label: "Clients" }];
  return (
    <section id="about" style={{ padding: "6rem 5vw", maxWidth: 1100, margin: "0 auto", borderTop: "1px solid var(--border)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.65fr", gap: "4rem", alignItems: "start" }}>
        <FadeIn delay={0.05}>
          <div style={{ aspectRatio: "3/4", background: "var(--surface2)", borderRadius: 3, border: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
            <span style={{ fontFamily: "var(--serif)", fontSize: "5.5rem", fontWeight: 300, color: "var(--ink3)" }}>YN</span>
            <div style={{ position: "absolute", bottom: "1.25rem", left: "1.25rem", background: "var(--ink)", color: "var(--surface)", padding: "0.4rem 1rem", fontSize: "0.7rem", letterSpacing: "0.08em", textTransform: "uppercase", borderRadius: 2 }}>Web Developer</div>
          </div>
        </FadeIn>
        <div>
          ...
          <FadeIn delay={0.15}>
            <p style={{ color: "var(--ink2)", marginBottom: "1.25rem", fontWeight: 300, lineHeight: 1.8, fontSize: "0.95rem" }}>Hi! I'm a passionate web developer who loves turning complex problems into elegant, simple solutions. I care deeply about code quality, design details, and the experience of every user who touches what I build.</p>
            <p style={{ color: "var(--ink2)", fontWeight: 300, lineHeight: 1.8, fontSize: "0.95rem" }}>Whether it's a landing page, a full-stack application, or an interactive UI — I bring the same level of craft and attention to every project. I believe the best websites feel effortless.</p>
          </FadeIn>
          <FadeIn delay={0.2}>
...
/* ── SKILLS ── */
const skillGroups = [
  { label: "Frontend", skills: ["React", "Vue.js", "Next.js", "TypeScript", "JavaScript", "HTML5", "CSS3", "Tailwind CSS"], featured: ["React", "Vue.js", "Next.js"] },
  { label: "Backend", skills: ["Node.js", "Express.js", "REST APIs", "GraphQL", "PHP"], featured: ["Node.js"] },
  { label: "Database & Tools", skills: ["MongoDB", "PostgreSQL", "MySQL", "Firebase", "Git / GitHub", "Docker", "Figma"], featured: [] },
];
    ...
    <section id="skills" style={{ padding: "6rem 5vw", maxWidth: 1100, margin: "0 auto", borderTop: "1px solid var(--border)" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
        <div>
          ...
          <FadeIn delay={0.1}>
            <p style={{ color: "var(--ink2)", fontWeight: 300, lineHeight: 1.8, marginBottom: "1rem", fontSize: "0.95rem" }}>I work across the full web stack — from pixel-perfect front-end interfaces to robust back-end systems.</p>
            <p style={{ color: "var(--ink2)", fontWeight: 300, lineHeight: 1.8, fontSize: "0.95rem" }}>Always learning, always building.</p>
          </FadeIn>
        </div>
...
function Contact() {
  ...
  const socialLinks = [
    { label: "Email", val: "your@email.com", href: "mailto:your@email.com", icon: <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><rect x="1" y="3" width="13" height="9" rx="1.5" stroke="currentColor" strokeWidth="1.1" /><path d="M1 5l6.5 4.5L14 5" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round" /></svg> },
    { label: "GitHub", val: "github.com/yourhandle", href: "https://github.com", icon: <svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M8 1.5a6.5 6.5 0 00-2.055 12.67c.325.06.443-.14.443-.312v-1.227c-1.81.393-2.19-.874-2.19-.874-.296-.75-.722-.95-.722-.95-.59-.403.044-.395.044-.395.652.046 1 .67 1 .67.58 1 1.524.71 1.895.543.059-.422.228-.71.415-.874-1.445-.163-2.963-.722-2.963-3.21 0-.708.254-1.288.67-1.74-.068-.164-.29-.824.063-1.717 0 0 .546-.175 1.788.666A6.23 6.23 0 018 5.75c.552.003 1.108.075 1.628.219 1.24-.84 1.786-.666 1.786-.666.354.893.131 1.553.064 1.717.418.452.67 1.032.67 1.74 0 2.495-1.52 3.044-2.97 3.205.234.2.442.598.442 1.205v1.786c0 .174.118.375.447.312A6.502 6.502 0 008 1.5z" fill="currentColor" /></svg> },
